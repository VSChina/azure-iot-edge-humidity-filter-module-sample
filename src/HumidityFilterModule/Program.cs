namespace FilterModule
{
    ...
    public class Program
    {
        ...
        {
            const string humidityThresholdProperty = "HumidityThreshold";
            try
            {
                Console.WriteLine("Desired property change:");
                Console.WriteLine(JsonConvert.SerializeObject(desiredProperties));

                if (desiredProperties.Contains(humidityThresholdProperty) 
                    && desiredProperties[humidityThresholdProperty] != null)
                    humidityThreshold = desiredProperties[humidityThresholdProperty];
        ...
        public static Message Filter(Message message)
        {
            ...
            {
                Console.WriteLine($"Ambient humidity {messageBody.ambient.humidity} exceeds threshold {humidityThreshold}");
